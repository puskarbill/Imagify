  ...
  return (
    ...
    {!isImageLoaded &&
      <div className='flex w-full max-w-xl bg-neutral-500 text-white text-sm mt-10 rounded-full'>
        ...
        <input onChange={e=> setInput(e.target.value)} value={input} type='text' placeholder='Describe what u want to generate ' className='flex-1 bg-transparent outline-none ml-8 max-sm:w-20 placeholder-color' />
        <button type='submit' className='bg-zinc-900 text-white-600  px-10 sm:px-16 py-3 rounded-full'>Generate</button>
    ...
    {isImageLoaded &&
      <div className='flex gap-2 flex-wrap justify-center text-white text-sm p-0.5 rounded-full'>
        ...
        '>Generate Another</p>
        <a href={image} download className='bg-zinc-900 border border-zinc-900 text-white px-8 py-3 rounded-full cursor-pointer'>Download</a>
